...
.. sinfo -S  '-R -D c' -p standard,highmem,hugemem,maxmem,gpu,standard-hbm,gpu-hugemem,gpu32 -o "   | %5D | %4c | %9m | %38f | %14G | " -e  | sed 's/(null)/      /'
...
.. table::
   ...
   +-------+------+-----------+----------------------------------------+----------------+
   | 3     | 32   | 257000    | amd,epyc,epyc9115,mlx5_ib,nvme,fastscr | gpu:RTX6000:4  | 
   +-------+------+-----------+----------------------------------------+----------------+
