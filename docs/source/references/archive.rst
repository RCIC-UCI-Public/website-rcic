...
Software changes:
  ...
  .. [#] **IMPORTANT:** If you are currently using miniconda/4.8.5 or miniconda3/4.12.0
...
.. table:: 
   ...
   | Agenda                                                                     |
   +==========+=================================================================+
   | **UCI computing and data infrastructure**                                  |
   +----------+-----------------------------------------------------------------+
   ...
   | 11:00 am | Break                                                           |
   +----------+-----------------------------------------------------------------+
   | **HPC and HTC applications in research**                                   |
   +----------+-----------------------------------------------------------------+
   ...
   +----------+-----------------------------------------------------------------+
   | **HPC and HTC in teaching and outreach**                                   |
   +----------+-----------------------------------------------------------------+
